    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "pagesize",
                    models.PositiveIntegerField(verbose_name="page size", default=100),
                ),
                (
                    "horizonbuckets",
                    models.CharField(null=True, blank=True, max_length=300),
                ),
                ...
                (
                    "horizonlength",
                    models.IntegerField(blank=True, null=True, default=6),
                ),
                (
                    "horizonunit",
                    models.CharField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        verbose_name="name", db_index=True, max_length=300
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "value",
                    models.CharField(
                        null=True, verbose_name="value", blank=True, max_length=1000
                    ),
                ),
                (
                    "description",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "lastrefresh",
                    models.DateTimeField(
                        null=True, editable=False, verbose_name="last refreshed"
                    ),
                ),
            ],
            options={
        ...
        migrations.AlterUniqueTogether(
            name="bucketdetail", unique_together=set([("bucket", "startdate")])
        ),
    ]
