    ...
    operations = [
        migrations.CreateModel(
            ...
            fields = [
                ...
                ('language', models.CharField(
                    choices = [('auto', 'Detect automatically'), ('en', 'English'), ('es', 'Spanish'), ('fr', 'French'), ('it', 'Italian'), ('ja', 'Japanese'), ('nl', 'Dutch'), ('pt', 'Portuguese'), ('pt-br', 'Brazilian Portuguese'),
                               ('zh-cn', 'Simplified Chinese'), ('zh-tw', 'Traditional Chinese')], verbose_name = 'language', default = 'auto', max_length = 10)),
                ('theme',
                 models.CharField(max_length = 20, choices = [('grass', 'Grass'), ('lemon', 'Lemon'), ('water', 'Water'), ('snow', 'Snow'), ('strawberry', 'Strawberry'), ('earth', 'Earth')], verbose_name = 'theme', default = 'grass')),
                ...
                ('groups', models.ManyToManyField(related_name = 'user_set', to = 'auth.Group', verbose_name = 'groups', related_query_name = 'user', blank = True,
        ...
        migrations.CreateModel(
            ...
            fields = [
                ...
                ('bucket', models.ForeignKey(verbose_name = 'bucket', to = 'common.Bucket', on_delete = None)),
            ],
            options = {
        ...
        migrations.CreateModel(
            ...
            fields = [
                ...
                ('content_type', models.ForeignKey(related_name = 'content_type_set_for_comment', verbose_name = 'content type', to = 'contenttypes.ContentType', on_delete = None)),
                ('user', models.ForeignKey(verbose_name = 'user', null = True, editable = False, blank = True, to = settings.AUTH_USER_MODEL, on_delete = None)),
            ],
            options = {
