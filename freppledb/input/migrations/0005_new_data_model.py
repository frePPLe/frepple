...
class Migration(migrations.Migration):
  ...
  operations = [
    ...
    migrations.AlterField(
      ...
      name='calendar',
      field=models.ForeignKey(to='input.Calendar', related_name='buckets', verbose_name='Calendar', on_delete = None),
    ),
    ...
    migrations.AlterField(
      ...
      name='operation',
      field=models.ForeignKey(verbose_name='operation', related_name='operationresources', to='input.Operation', on_delete = None),
    ),
    migrations.AlterField(
      model_name='operationresource',
      name='resource',
      field=models.ForeignKey(verbose_name='resource', related_name='operationresources', to='input.Resource', on_delete = None),
    ),
    migrations.AlterField(
      model_name='operationresource',
      name='skill',
      field=models.ForeignKey(blank=True, related_name='operationresources', null=True, verbose_name='skill', to='input.Skill', on_delete = None),
    ),
    ...
    migrations.AddField(
      ...
      name='item',
      field=models.ForeignKey(verbose_name='item', to='input.Item', related_name='operationmaterials', null=True, on_delete = None),
    ...
    migrations.AlterField(
      model_name='operationmaterial',
      name='item',
      field=models.ForeignKey(related_name='operationmaterials', to='input.Item', verbose_name='item', on_delete = None),
    ),
    migrations.AlterUniqueTogether(
      name='operationmaterial',
    ...
    migrations.AlterField(
      model_name='operationmaterial',
      name='operation',
      field=models.ForeignKey(verbose_name='operation', related_name='operationmaterials', to='input.Operation', on_delete = None),
    ),
    ...
    migrations.AlterField(
      model_name='item',
      name='operation',
      field=models.ForeignKey(related_name='operation', verbose_name='delivery operation', to='input.Operation', blank=True, null=True, help_text='Default operation used to ship a demand for this item', on_delete = None),
    ),
    ...
    migrations.CreateModel(
      ...
      fields=[
        ...
        ('operationplan', models.ForeignKey(verbose_name='operationplan', to='input.OperationPlan', on_delete = None)),
      ],
      options={
    ...
    migrations.AddField(
      model_name='operationplan',
      name='destination',
      field=models.ForeignKey(to='input.Location', blank=True, related_name='destinations', null=True, verbose_name='destination', on_delete = None),
    ),
    migrations.AddField(
      model_name='operationplan',
      name='item',
      field=models.ForeignKey(to='input.Item', blank=True, null=True, verbose_name='item', on_delete = None),
    ),
    migrations.AddField(
      model_name='operationplan',
      name='location',
      field=models.ForeignKey(to='input.Location', blank=True, null=True, verbose_name='location', on_delete = None),
    ),
    migrations.AddField(
      model_name='operationplan',
      name='origin',
      field=models.ForeignKey(to='input.Location', blank=True, related_name='origins', null=True, verbose_name='origin', on_delete = None),
    ),
    migrations.AddField(
      model_name='operationplan',
      name='supplier',
      field=models.ForeignKey(to='input.Supplier', blank=True, null=True, verbose_name='supplier', on_delete = None),
    ),
    migrations.AddField(
      model_name='operationplan',
      name='type',
    ...
    migrations.AddField(
      model_name='operationplan',
      name='demand',
      field=models.ForeignKey(to='input.Demand', blank=True, null=True, verbose_name='demand', on_delete = None),
    ),
    migrations.AddField(
      model_name='operationplan',
      name='name',
    ...
    migrations.AlterField(
      model_name='operationplan',
      name='operation',
      field=models.ForeignKey(to='input.Operation', blank=True, null=True, verbose_name='operation', on_delete = None),
    ),
    migrations.AlterField(
      model_name='operationplan',
      name='status',
