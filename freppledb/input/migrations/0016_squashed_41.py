    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('calendar', models.ForeignKey(verbose_name='calendar', related_name='buckets', to='input.Calendar', on_delete = None)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(max_length=300, db_index=True, blank=True, verbose_name='category', null=True)),
                ('subcategory', models.CharField(max_length=300, db_index=True, blank=True, verbose_name='subcategory', null=True)),
                ('owner', models.ForeignKey(blank=True, verbose_name='owner', related_name='xchildren', to='input.Customer', help_text='Hierarchical parent', null=True, on_delete = None)),
            ],
            options={
                'db_table': 'customer',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('customer', models.ForeignKey(to='input.Customer', verbose_name='customer', on_delete = None)),
            ],
            options={
                'db_table': 'demand',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('owner', models.ForeignKey(blank=True, verbose_name='owner', related_name='xchildren', to='input.Item', help_text='Hierarchical parent', null=True, on_delete = None)),
            ],
            options={
                'db_table': 'item',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('item', models.ForeignKey(verbose_name='item', related_name='distributions', to='input.Item', on_delete = None)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('item', models.ForeignKey(verbose_name='item', related_name='itemsuppliers', to='input.Item', on_delete = None)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(max_length=300, db_index=True, blank=True, verbose_name='category', null=True)),
                ('subcategory', models.CharField(max_length=300, db_index=True, blank=True, verbose_name='subcategory', null=True)),
                ('available', models.ForeignKey(blank=True, verbose_name='available', to='input.Calendar', help_text='Calendar defining the working hours and holidays of this location', null=True, on_delete = None)),
                ('owner', models.ForeignKey(blank=True, verbose_name='owner', related_name='xchildren', to='input.Location', help_text='Hierarchical parent', null=True, on_delete = None)),
            ],
            options={
                'db_table': 'location',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('item', models.ForeignKey(blank=True, verbose_name='item', related_name='operations', to='input.Item', null=True, on_delete = None)),
                ('location', models.ForeignKey(to='input.Location', verbose_name='location', on_delete = None)),
            ],
            options={
                'db_table': 'operation',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('search', models.CharField(max_length=20, blank=True, verbose_name='search mode', help_text='Method to select preferred alternate', choices=[('PRIORITY', 'priority'), ('MINCOST', 'minimum cost'), ('MINPENALTY', 'minimum penalty'), ('MINCOSTPENALTY', 'minimum cost plus penalty')], null=True)),
                ('item', models.ForeignKey(verbose_name='item', related_name='operationmaterials', to='input.Item', on_delete = None)),
                ('operation', models.ForeignKey(verbose_name='operation', related_name='operationmaterials', to='input.Operation', on_delete = None)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('demand', models.ForeignKey(blank=True, verbose_name='demand', to='input.Demand', null=True, on_delete = None)),
                ('destination', models.ForeignKey(blank=True, verbose_name='destination', related_name='destinations', to='input.Location', null=True, on_delete = None)),
                ('item', models.ForeignKey(blank=True, verbose_name='item', to='input.Item', null=True, on_delete = None)),
                ('location', models.ForeignKey(blank=True, verbose_name='location', to='input.Location', null=True, on_delete = None)),
                ('operation', models.ForeignKey(blank=True, verbose_name='operation', to='input.Operation', null=True, on_delete = None)),
                ('origin', models.ForeignKey(blank=True, verbose_name='origin', related_name='origins', to='input.Location', null=True, on_delete = None)),
                ('owner', models.ForeignKey(blank=True, verbose_name='owner', related_name='xchildren', to='input.OperationPlan', help_text='Hierarchical parent', null=True, on_delete = None)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('item', models.ForeignKey(blank=True, verbose_name='item', related_name='operationplanmaterials', to='input.Item', null=True, on_delete = None)),
                ('location', models.ForeignKey(blank=True, verbose_name='location', related_name='operationplanmaterials', to='input.Location', null=True, on_delete = None)),
                ('operationplan', models.ForeignKey(verbose_name='operationplan', related_name='materials', to='input.OperationPlan', on_delete = None)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('operationplan', models.ForeignKey(verbose_name='operationplan', related_name='resources', to='input.OperationPlan', on_delete = None)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('search', models.CharField(max_length=20, blank=True, verbose_name='search mode', help_text='Method to select preferred alternate', choices=[('PRIORITY', 'priority'), ('MINCOST', 'minimum cost'), ('MINPENALTY', 'minimum penalty'), ('MINCOSTPENALTY', 'minimum cost plus penalty')], null=True)),
                ('operation', models.ForeignKey(verbose_name='operation', related_name='operationresources', to='input.Operation', on_delete = None)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('location', models.ForeignKey(blank=True, verbose_name='location', to='input.Location', null=True, on_delete = None)),
                ('maximum_calendar', models.ForeignKey(blank=True, verbose_name='maximum calendar', to='input.Calendar', help_text='Calendar defining the resource size varying over time', null=True, on_delete = None)),
                ('owner', models.ForeignKey(blank=True, verbose_name='owner', related_name='xchildren', to='input.Resource', help_text='Hierarchical parent', null=True, on_delete = None)),
            ],
            options={
                'db_table': 'resource',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('resource', models.ForeignKey(verbose_name='resource', related_name='skills', to='input.Resource', on_delete = None)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('setupmatrix', models.ForeignKey(verbose_name='setup matrix', related_name='rules', to='input.SetupMatrix', on_delete = None)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('effective_start', models.DateTimeField(blank=True, verbose_name='effective start', null=True, help_text='Validity start date')),
                ('effective_end', models.DateTimeField(blank=True, verbose_name='effective end', null=True, help_text='Validity end date')),
                ('operation', models.ForeignKey(help_text='Parent operation', verbose_name='operation', related_name='suboperations', to='input.Operation', on_delete = None)),
                ('suboperation', models.ForeignKey(help_text='Child operation', verbose_name='suboperation', related_name='superoperations', to='input.Operation', on_delete = None)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(max_length=300, db_index=True, blank=True, verbose_name='category', null=True)),
                ('subcategory', models.CharField(max_length=300, db_index=True, blank=True, verbose_name='subcategory', null=True)),
                ('owner', models.ForeignKey(blank=True, verbose_name='owner', related_name='xchildren', to='input.Supplier', help_text='Hierarchical parent', null=True, on_delete = None)),
            ],
            options={
                'db_table': 'supplier',
        ...
        migrations.AddField(
            ...
            name='skill',
            field=models.ForeignKey(verbose_name='skill', related_name='resources', to='input.Skill', on_delete = None),
        ),
        migrations.AddField(
            model_name='resource',
            name='setupmatrix',
            field=models.ForeignKey(blank=True, verbose_name='setup matrix', to='input.SetupMatrix', help_text='Setup matrix defining the conversion time and cost', null=True, on_delete = None),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='operationresource',
            name='skill',
            field=models.ForeignKey(blank=True, verbose_name='skill', related_name='operationresources', to='input.Skill', null=True, on_delete = None),
        ),
        migrations.AddField(
            model_name='operationplan',
            name='supplier',
            field=models.ForeignKey(blank=True, verbose_name='supplier', to='input.Supplier', null=True, on_delete = None),
        ),
        migrations.AddField(
            model_name='itemsupplier',
            name='location',
            field=models.ForeignKey(blank=True, verbose_name='location', related_name='itemsuppliers', to='input.Location', null=True, on_delete = None),
        ),
        migrations.AddField(
            model_name='itemsupplier',
            name='resource',
            field=models.ForeignKey(blank=True, verbose_name='resource', related_name='itemsuppliers', to='input.Resource', help_text='Resource to model the supplier capacity', null=True, on_delete = None),
        ),
        migrations.AddField(
            model_name='itemsupplier',
            name='supplier',
            field=models.ForeignKey(verbose_name='supplier', related_name='suppliers', to='input.Supplier', on_delete = None),
        ),
        migrations.AddField(
            model_name='itemdistribution',
            name='location',
            field=models.ForeignKey(blank=True, verbose_name='location', related_name='itemdistributions_destination', to='input.Location', null=True, on_delete = None),
        ),
        migrations.AddField(
            model_name='itemdistribution',
            name='origin',
            field=models.ForeignKey(verbose_name='origin', related_name='itemdistributions_origin', to='input.Location', on_delete = None),
        ),
        migrations.AddField(
            model_name='itemdistribution',
            name='resource',
            field=models.ForeignKey(blank=True, verbose_name='resource', related_name='itemdistributions', to='input.Resource', help_text='Resource to model the distribution capacity', null=True, on_delete = None),
        ),
        migrations.AddField(
            model_name='demand',
            name='item',
            field=models.ForeignKey(to='input.Item', verbose_name='item', on_delete = None),
        ),
        migrations.AddField(
            model_name='demand',
            name='location',
            field=models.ForeignKey(to='input.Location', verbose_name='location', on_delete = None),
        ),
        migrations.AddField(
            model_name='demand',
            name='operation',
            field=models.ForeignKey(blank=True, verbose_name='delivery operation', related_name='used_demand', to='input.Operation', help_text='Operation used to satisfy this demand', null=True, on_delete = None),
        ),
        migrations.AddField(
            model_name='demand',
            name='owner',
            field=models.ForeignKey(blank=True, verbose_name='owner', related_name='xchildren', to='input.Demand', help_text='Hierarchical parent', null=True, on_delete = None),
        ),
        migrations.AddField(
            model_name='buffer',
            name='item',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(blank=True, verbose_name='minimum calendar', to='input.Calendar', help_text='Calendar storing a time-dependent safety stock profile', null=True, on_delete = None),
        ),
        migrations.AddField(
            model_name='buffer',
            name='owner',
            field=models.ForeignKey(blank=True, verbose_name='owner', related_name='xchildren', to='input.Buffer', help_text='Hierarchical parent', null=True, on_delete = None),
        ),
        migrations.CreateModel(
            name='DeliveryOrder',
            fields=[
