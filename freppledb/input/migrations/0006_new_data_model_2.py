...
class Migration(migrations.Migration):
    ...
    dependencies = [("input", "0005_new_data_model")]
    ...
    operations = [
      ...
      """,
        ...
        migrations.RemoveField(model_name="distributionorder", name="destination"),
        migrations.RemoveField(model_name="distributionorder", name="item"),
        migrations.RemoveField(model_name="distributionorder", name="origin"),
        migrations.RemoveField(model_name="purchaseorder", name="item"),
        migrations.RemoveField(model_name="purchaseorder", name="location"),
        ...
        migrations.DeleteModel(name="DistributionOrder"),
      ...
      """,
        ...
        migrations.RemoveField(model_name="buffer", name="producing"),
