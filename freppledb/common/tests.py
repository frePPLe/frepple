...
class ExcelTest(TransactionTestCase):
    ...
    def run_workbook(self, language):
        ...
        self.assertEqual(
            input.models.CalendarBucket.objects.count(), countCalendarBucket
        )
        ...
        self.assertEqual(
            input.models.OperationMaterial.objects.count(), countOperationMaterial
        )
        self.assertEqual(input.models.Item.objects.count(), countItem)
        self.assertEqual(
            input.models.ItemDistribution.objects.count(), countItemDistribution
        )
        self.assertEqual(input.models.ItemSupplier.objects.count(), countItemSupplier)
        self.assertEqual(
            input.models.OperationResource.objects.count(), countOperationResource
        )
        ...
        self.assertEqual(
            input.models.DistributionOrder.objects.count(), countDistributionOrder
        )
        self.assertEqual(
            input.models.ManufacturingOrder.objects.count(), countManufacturingOrder
        )
...
class freppleREST(APITestCase):
    ...
    def test_api_demand(self):
        ...
        self.assertEqual(
            input.models.Demand.objects.filter(name="Order UFO 25").count(), 1
        )
        data = {
            "name": "Order UFO 26",
            "description": None,
        ...
        self.assertEqual(
            input.models.Demand.objects.filter(name="Order UFO 26").count(), 1
        )
        ...
        self.assertEqual(
            input.models.Demand.objects.filter(category="TEST DELETE").count(), 2
        )
        ...
        self.assertEqual(
            input.models.Demand.objects.filter(description="Put multipart").count(), 1
        )
        ...
        self.assertEqual(input.models.Demand.objects.count(), recordsnumber + 4)
        self.assertEqual(
            input.models.Demand.objects.filter(description="Put json").count(), 1
        )
        ...
        self.assertEqual(input.models.Demand.objects.count(), recordsnumber + 4)
        self.assertEqual(
            input.models.Demand.objects.filter(description="Put form").count(), 1
        )
        ...
        self.assertEqual(response.status_code, 204)
        self.assertEqual(
            input.models.Customer.objects.filter(category="TEST DELETE").count(), 0
        )
    ...
    def test_api_customer(self):
        ...
        self.assertEqual(
            input.models.Customer.objects.count(), 3
        ...
        self.assertEqual(
            input.models.Customer.objects.filter(name="Customer near Area 51").count(),
            1,
        )
        ...
        self.assertEqual(
            input.models.Customer.objects.filter(name="Customer near Area 52").count(),
            1,
        )
        data = [
        ...
        self.assertEqual(
            input.models.Customer.objects.filter(source="TEST DELETE").count(), 2
        )
        ...
        self.assertEqual(input.models.Customer.objects.count(), recordsnumber + 4)
        self.assertEqual(
            input.models.Customer.objects.filter(description="Patch multipart").count(),
            1,
        )
        ...
        self.assertEqual(input.models.Customer.objects.count(), recordsnumber + 4)
        self.assertEqual(
            input.models.Customer.objects.filter(description="Patch json").count(), 1
        )
        ...
        self.assertEqual(input.models.Customer.objects.count(), recordsnumber + 4)
        self.assertEqual(
            input.models.Customer.objects.filter(source="Put json").count(), 1
        )
        ...
        self.assertEqual(response.status_code, 200)
        self.assertEqual(
            input.models.Customer.objects.filter(name__contains="Area").count(), 4
        )
        ...
        self.assertEqual(response.status_code, 204)
        self.assertEqual(
            input.models.Customer.objects.filter(name__contains="Area").count(), 2
        )
        # Single DELETE
        response = self.client.delete(
        ...
        self.assertEqual(response.status_code, 204)
        self.assertEqual(
            input.models.Customer.objects.filter(source="TEST DELETE").count(), 0
        )
