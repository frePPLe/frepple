...
class Migration(migrations.Migration):
  ...
  operations = [
    ...
    migrations.AlterField(
      model_name='buffer',
      name='item',
      field=models.ForeignKey(verbose_name='item', to='input.Item', on_delete=models.CASCADE),
    ),
    migrations.AlterField(
      model_name='buffer',
      name='location',
    ...
    migrations.AlterField(
      model_name='demand',
      name='customer',
      field=models.ForeignKey(verbose_name='customer', to='input.Customer', on_delete=models.CASCADE),
    ),
    migrations.AlterField(
      model_name='demand',
      name='item',
