...
DECLARE_EXPORT const XMLtag Tags::tag_enddate("enddate");
...
DECLARE_EXPORT const XMLtag Tags::tag_flowplan("flowplan");
DECLARE_EXPORT const XMLtag Tags::tag_flowplans("flowplans");
...
DECLARE_EXPORT const XMLtag Tags::tag_loadplan("loadplan");
DECLARE_EXPORT const XMLtag Tags::tag_loadplans("loadplans");
...
DECLARE_EXPORT const XMLtag Tags::tag_operationplan("operationplan");
DECLARE_EXPORT const XMLtag Tags::tag_operationplans("operationplans");
...
DECLARE_EXPORT const XMLtag Tags::tag_startdate("startdate");
