...
#. | :doc:`Install the software <installation-guide/windows-installer>` 
     or `register for a free trial on our cloud  <https://register.frepple.com/accounts/register/>`_
   | The easiest start to learn frePPLe is to use an online trial
...
#. | :doc:`Build your own model<user-guide/modeling-wizard/index>`
   | The application has an integrated wizard that will guide you through
     building your first model step by step.

#. | Visit the `community forum <https://groups.google.com/forum/#!forum/frepple-users>`_.
