var tourdata = [
     ...
     steps: [
             {
               ...
               description : `<strong>Welcome to frePPLe.</strong><br>
                 ...
                 During the first 5 days of use you will see this message to take the tour. 
   ...
   // Navigation
   {
    ...
    {
     description: 
        `<h2><span class="underline"><a href="/?tour=0,0,0"><i class="fa fa-home" aria-hidden="true"></i></a></span> &gt; Data maintenance</h2>
...
//           beforestep: 'document.getElementById().hover()',
         ...
         },
         {
           ...
           element : ".fa-wrench",
           description : 
            `Users of the Enterprise Edition also have the ability to <strong>customize the report</strong>:<br>
        ...
        [
         {
           ...
           description : `This report shows the <strong>bill of material</strong> or <strong>supply path</strong> of a particular item.<br>
             ...
             Every single graphical object in this graph is stored as a single record in the frePPLe model. 
             The graph allows you to verify that you have correctly filled in all data.<br>
     ...
     steps:
        [
         ...
         },
         {
           ...
           description : `You can <strong>generate constrained or unconstrained plans </strong><br>and select which constraints to consider.<br><br>
         ...
         },
         {
           ...
           description : `Here you can copy your dataset into a <strong>what-if scenario</strong>.<br><br>
             ...
             All data and plans can thus be vary independently.<br><br>
             Once a scenario has been copied, a dropdown list shows up in the upper right corner of the screen. 
             Here you select the scenario you want to work with.`,
           position : 'top'
         },
         {
           url: "/execute/",
           ...
           description : `You can create a <strong>backup</strong> of the database.<br><br>
             There is a restore command as well. As restoring the database requires some downtime 
             (and also for data security) it is only available from the command line.`,
           position : 'top'
         },
         {
           url: "/execute/",
           ...
           description : `This task <strong>erases the data</strong> from the selected tables.<br><br>
             When you mark a certain entities for erasing, all entities which depend on it will automatically also be selected.`,
           position : 'top'
         },
         {
           url: "/execute/",
      ...
      {
       description: `
          <h2><span class="underline"><a href="/?tour=0,0,0"><i class="fa fa-home" aria-hidden="true"></i></a></span> &gt; Plan analysis</h2>
          ...
          [
           {
             ...
             description : `This report shows the <strong>resource utilization</strong>
               ...
               Users of the Enterprise Edition also have a second report to visualize the resource plan in a <strong>Gantt chart</strong>.
               The Gantt chart shows all individual operations on the resource<br> as blocks on a timeline.`,
             position : 'bottom'
           },
           {
             url: "/resource/",
           ...
           },
           {
             ...
             description : `The <b>drilldown menu</b> allows you to look<br> at the plan of that particular resource<br>
           ...
           },
           {
             ...
             description : `This report shows the <b>inventory profile</b> of all item @ locations.<br>
               It displays how much inventory we plan to have for each raw<br> material, 
               end product or intermediate product.`,
             position : 'right'
           },
           {
             url: "/buffer/",
           ...
           },
           {
             ...
             description : `This report shows the <strong>detailed list of all planned operations</strong>.<br>
               This list would be typically be used to communicate the plan to operators<br>on the shop floor, 
               or integrate it to ERP and other systems.`,
             position : 'right'
           },
           {
             url: "/demand/",
           ...
           },
           {
             ...
             description : `This report shows <b>problem areas in the plan</b>.<br>
               Rather than browsing through all orders, resources and materials, this report allows you to focus directly on the exceptions.
           ...
           },
           {
             ...
             description : `Let's <b>analyze a late demand...</b><br><br>
               ...
               click on the demand to display the popup menu,<br> and select 'plan' from the menu.`,
             position : 'top'
           },
           {
           ...
           },
           {
             ...
             description : `All levels in the supply path / bill of material 
               ...
               You can <b>collapse</b> and <b>expand</b> branches by clicking on the icons.`,
             position : "top"
           },
           {
             url: "/demandpegging/Demand%2001/",
           ...
           },
           {
             ...
             description : `This report shows <b>why a particular demand is late or short</b>.<br>
               ...
               Some care is when interpreting these results: if a certain resource is identified as the cause, 
               it doesn't mean the resource is completely unavailable. 
               It only indicates that other demands with higher priority already used up all available capacity.`,
             position: "bottom"
           }
           ]
      },
      ...
      // A day in the life of a manufacturing planner
      {
       description: `<h2><span class="underline"><a href="/?tour=0,0,0"><i class="fa fa-home" aria-hidden="true"></i></a></span> &gt; A day in the life of a manufacturing planner</h2>
        The manufacturing planner's role is to make sure that demand is delivered on time by reviewing the supply chain capacity and material constraints.<br><br>`,
       delay: 5,
       steps:
        [
         {
