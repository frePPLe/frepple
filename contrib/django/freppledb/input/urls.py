...
urlpatterns = patterns(
  ...
  (r'^api/input/manufacturingorder/$', freppledb.input.serializers.OperationPlanAPI.as_view()),
  ...
  (r'^api/input/manufacturingorder/(?P<pk>(.+))/$', freppledb.input.serializers.OperationPlandetailAPI.as_view()),
