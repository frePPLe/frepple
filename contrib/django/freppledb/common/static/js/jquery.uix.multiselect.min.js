...
for(var t=0,s=this._elements.length;t<s;t++){var u=this._elements[t];v[u.selected?"selected":"available"][u.filtered?"filtered":"count"]++;v[u.selected?"selected":"available"].total++}return v},setSelected:function(u,t,s){if(u.optionElement.attr("disabled")){return
