    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('calendar', models.ForeignKey(related_name='buckets', verbose_name='calendar', to='input.Calendar', on_delete=models.CASCADE)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(null=True, blank=True, verbose_name='category', db_index=True, max_length=300)),
                ('subcategory', models.CharField(null=True, blank=True, verbose_name='subcategory', db_index=True, max_length=300)),
                ('owner', models.ForeignKey(verbose_name='owner', related_name='xchildren', null=True, blank=True, to='input.Customer', help_text='Hierarchical parent', on_delete=models.SET_NULL)),
            ],
            options={
                'db_table': 'customer',
                'ordering': ['name'],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('customer', models.ForeignKey(verbose_name='customer', null=True, blank=True, to='input.Customer', on_delete=models.CASCADE)),
            ],
            options={
                'db_table': 'demand',
                'ordering': ['name'],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('effective_start', models.DateTimeField(null=True, verbose_name='effective start', blank=True, help_text='Validity start date')),
                ('effective_end', models.DateTimeField(null=True, verbose_name='effective end', blank=True, help_text='Validity end date')),
                ('item', models.ForeignKey(related_name='distributions', verbose_name='item', to='input.Item', on_delete=models.CASCADE)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('effective_start', models.DateTimeField(null=True, verbose_name='effective start', blank=True, help_text='Validity start date')),
                ('effective_end', models.DateTimeField(null=True, verbose_name='effective end', blank=True, help_text='Validity end date')),
                ('item', models.ForeignKey(related_name='itemsuppliers', verbose_name='item', to='input.Item', on_delete=models.CASCADE)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(null=True, blank=True, verbose_name='category', db_index=True, max_length=300)),
                ('subcategory', models.CharField(null=True, blank=True, verbose_name='subcategory', db_index=True, max_length=300)),
                ('available', models.ForeignKey(verbose_name='available', null=True, blank=True, to='input.Calendar', help_text='Calendar defining the working hours and holidays of this location', on_delete=models.SET_NULL)),
                ('owner', models.ForeignKey(verbose_name='owner', related_name='xchildren', null=True, blank=True, to='input.Location', help_text='Hierarchical parent', on_delete=models.SET_NULL)),
            ],
            options={
                'db_table': 'location',
                'ordering': ['name'],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('search', models.CharField(verbose_name='search mode', null=True, max_length=20, choices=[('PRIORITY', 'priority'), ('MINCOST', 'minimum cost'), ('MINPENALTY', 'minimum penalty'), ('MINCOSTPENALTY', 'minimum cost plus penalty')], blank=True, help_text='Method to select preferred alternate')),
                ('location', models.ForeignKey(verbose_name='location', null=True, blank=True, to='input.Location', on_delete=models.CASCADE)),
            ],
            options={
                'db_table': 'operation',
                'ordering': ['name'],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('enddate', models.DateTimeField(null=True, verbose_name='end date', blank=True, help_text='end date')),
                ('criticality', models.DecimalField(null=True, max_digits=15, verbose_name='criticality', blank=True, decimal_places=4)),
                ('operation', models.ForeignKey(verbose_name='operation', to='input.Operation', on_delete=models.CASCADE)),
                ('owner', models.ForeignKey(verbose_name='owner', related_name='xchildren', null=True, blank=True, to='input.OperationPlan', help_text='Hierarchical parent', on_delete=models.CASCADE)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('enddate', models.DateTimeField(null=True, verbose_name='end date', blank=True, help_text='end date')),
                ('criticality', models.DecimalField(null=True, max_digits=15, verbose_name='criticality', blank=True, decimal_places=4)),
                ('item', models.ForeignKey(verbose_name='item', to='input.Item', on_delete=models.CASCADE)),
                ('location', models.ForeignKey(verbose_name='location', to='input.Location', on_delete=models.CASCADE)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('location', models.ForeignKey(verbose_name='location', null=True, blank=True, to='input.Location', on_delete=models.CASCADE)),
                ('maximum_calendar', models.ForeignKey(verbose_name='maximum calendar', null=True, blank=True, to='input.Calendar', help_text='Calendar defining the resource size varying over time', on_delete=models.SET_NULL)),
                ('owner', models.ForeignKey(verbose_name='owner', related_name='xchildren', null=True, blank=True, to='input.Resource', help_text='Hierarchical parent', on_delete=models.SET_NULL)),
            ],
            options={
                'db_table': 'resource',
                'ordering': ['name'],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('resource', models.ForeignKey(related_name='skills', verbose_name='resource', to='input.Resource', on_delete=models.CASCADE)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('setupmatrix', models.ForeignKey(related_name='rules', verbose_name='setup matrix', to='input.SetupMatrix', on_delete=models.CASCADE)),
            ],
            options={
                'db_table': 'setuprule',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('effective_start', models.DateTimeField(null=True, verbose_name='effective start', blank=True, help_text='Validity start date')),
                ('effective_end', models.DateTimeField(null=True, verbose_name='effective end', blank=True, help_text='Validity end date')),
                ('operation', models.ForeignKey(related_name='suboperations', verbose_name='operation', to='input.Operation', help_text='Parent operation', on_delete=models.CASCADE)),
                ('suboperation', models.ForeignKey(related_name='superoperations', verbose_name='suboperation', to='input.Operation', help_text='Child operation', on_delete=models.CASCADE)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(null=True, blank=True, verbose_name='category', db_index=True, max_length=300)),
                ('subcategory', models.CharField(null=True, blank=True, verbose_name='subcategory', db_index=True, max_length=300)),
                ('owner', models.ForeignKey(verbose_name='owner', related_name='xchildren', null=True, blank=True, to='input.Supplier', help_text='Hierarchical parent', on_delete=models.SET_NULL)),
            ],
            options={
                'db_table': 'supplier',
                'ordering': ['name'],
        ...
        migrations.AddField(
            ...
            name='skill',
            field=models.ForeignKey(related_name='resources', verbose_name='skill', to='input.Skill', on_delete=models.CASCADE),
        ),
        migrations.AddField(
            model_name='resource',
            name='setupmatrix',
            field=models.ForeignKey(verbose_name='setup matrix', null=True, blank=True, to='input.SetupMatrix', help_text='Setup matrix defining the conversion time and cost', on_delete=models.SET_NULL),
        ),
        migrations.AddField(
            model_name='purchaseorder',
            name='supplier',
            field=models.ForeignKey(verbose_name='supplier', to='input.Supplier', on_delete=models.CASCADE),
        ),
        migrations.AddField(
            model_name='load',
            name='operation',
            field=models.ForeignKey(related_name='loads', verbose_name='operation', to='input.Operation', on_delete=models.CASCADE),
        ),
        migrations.AddField(
            model_name='load',
            name='resource',
            field=models.ForeignKey(related_name='loads', verbose_name='resource', to='input.Resource', on_delete=models.CASCADE),
        ),
        migrations.AddField(
            model_name='load',
            name='skill',
            field=models.ForeignKey(verbose_name='skill', related_name='loads', null=True, blank=True, to='input.Skill', on_delete=models.SET_NULL),
        ),
        migrations.AddField(
            model_name='itemsupplier',
            name='location',
            field=models.ForeignKey(verbose_name='location', related_name='itemsuppliers', null=True, blank=True, to='input.Location', on_delete=models.CASCADE),
        ),
        migrations.AddField(
            model_name='itemsupplier',
            name='supplier',
            field=models.ForeignKey(related_name='suppliers', verbose_name='supplier', to='input.Supplier', on_delete=models.CASCADE),
        ),
        migrations.AddField(
            model_name='itemdistribution',
            name='location',
            field=models.ForeignKey(verbose_name='location', related_name='itemdistributions_destination', null=True, blank=True, to='input.Location', on_delete=models.CASCADE),
        ),
        migrations.AddField(
            model_name='itemdistribution',
            name='origin',
            field=models.ForeignKey(related_name='itemdistributions_origin', verbose_name='origin', to='input.Location', on_delete=models.CASCADE),
        ),
        migrations.AddField(
            model_name='item',
            name='operation',
            field=models.ForeignKey(verbose_name='delivery operation', null=True, blank=True, to='input.Operation', help_text='Default operation used to ship a demand for this item', on_delete=models.SET_NULL),
        ),
        migrations.AddField(
            model_name='item',
            name='owner',
            field=models.ForeignKey(verbose_name='owner', related_name='xchildren', null=True, blank=True, to='input.Item', help_text='Hierarchical parent', on_delete=models.SET_NULL),
        ),
        migrations.AddField(
            model_name='flow',
            name='operation',
            field=models.ForeignKey(related_name='flows', verbose_name='operation', to='input.Operation', on_delete=models.CASCADE),
        ),
        migrations.AddField(
            model_name='flow',
            name='thebuffer',
            field=models.ForeignKey(related_name='flows', verbose_name='buffer', to='input.Buffer', on_delete=models.CASCADE),
        ),
        migrations.AddField(
            model_name='distributionorder',
            name='destination',
            field=models.ForeignKey(related_name='destinations', verbose_name='destination', to='input.Location', on_delete=models.CASCADE),
        ),
        migrations.AddField(
            model_name='distributionorder',
            name='item',
        ...
        migrations.AddField(
            model_name='distributionorder',
            name='origin',
            field=models.ForeignKey(verbose_name='origin', related_name='origins', null=True, blank=True, to='input.Location', on_delete=models.CASCADE),
        ),
        migrations.AddField(
            model_name='demand',
            name='item',
            field=models.ForeignKey(verbose_name='item', null=True, blank=True, to='input.Item', on_delete=models.CASCADE),
        ),
        migrations.AddField(
            model_name='demand',
            name='location',
            field=models.ForeignKey(verbose_name='location', null=True, blank=True, to='input.Location', on_delete=models.CASCADE),
        ),
        migrations.AddField(
            model_name='demand',
            name='operation',
            field=models.ForeignKey(verbose_name='delivery operation', related_name='used_demand', null=True, blank=True, to='input.Operation', help_text='Operation used to satisfy this demand', on_delete=models.CASCADE),
        ),
        migrations.AddField(
            model_name='demand',
            name='owner',
            field=models.ForeignKey(verbose_name='owner', related_name='xchildren', null=True, blank=True, to='input.Demand', help_text='Hierarchical parent', on_delete=models.SET_NULL),
        ),
        migrations.AddField(
            model_name='buffer',
            name='item',
            field=models.ForeignKey(verbose_name='item', null=True, to='input.Item', on_delete=models.CASCADE),
        ),
        migrations.AddField(
            model_name='buffer',
            name='location',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(verbose_name='minimum calendar', null=True, blank=True, to='input.Calendar', help_text='Calendar storing a time-dependent safety stock profile', on_delete=models.SET_NULL),
        ),
        migrations.AddField(
            model_name='buffer',
            name='owner',
            field=models.ForeignKey(verbose_name='owner', related_name='xchildren', null=True, blank=True, to='input.Buffer', help_text='Hierarchical parent', on_delete=models.SET_NULL),
        ),
        migrations.AddField(
            model_name='buffer',
            name='producing',
            field=models.ForeignKey(verbose_name='producing', related_name='used_producing', null=True, blank=True, to='input.Operation', help_text='Operation to replenish the buffer', on_delete=models.SET_NULL),
        ),
