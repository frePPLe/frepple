...
DECLARE_EXPORT const Keyword Tags::delay("delay");
DECLARE_EXPORT const Keyword Tags::delivery("delivery");
...
DECLARE_EXPORT const Keyword Tags::feasible("feasible");
...
DECLARE_EXPORT const Keyword Tags::pegging_demand("pegging_demand");
...
DECLARE_EXPORT const Keyword Tags::planned_quantity("planned_quantity");
