...
* `Generate a plan`_
* `Export a spreadsheet`_
* `Import a spreadsheet`_
* `Export plan result to folder`_
* `Import data files from folder`_
* `Web service`_
* `Scenario management`_
* `Back up database`_
* `Empty the database`_
* `Load a dataset in the database`_
* `Generate time buckets`_
