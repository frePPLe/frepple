...
Requires: libxerces-c-3_1, openssl, httpd, apache2-mod_wsgi-python3, python3, python3-psycopg2, postgresql
...
install -m 644 -p contrib/linux/opensuse-15.1/httpd.conf $RPM_BUILD_ROOT%{_sysconfdir}/httpd/conf.d/z_frepple.conf
