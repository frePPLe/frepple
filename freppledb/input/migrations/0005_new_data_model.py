...
def CheckReadyForMigration(apps, schema_editor):
    ...
    if cnt:
        ...
        msg.append(
            "You will need to update the %d violating records in the operation table."
            % cnt
        )
    ...
    cnt = (
        Flow.objects.all()
        .using(db)
        .filter(~Q(thebuffer__location__name=F("operation__location__name")))
    )
    if cnt:
        msg.append(
        ...
        msg.append(
            "You will need to change the %s operations and use itemdistributions to move material between locations."
            % cnt
        )
    if msg:
...
class Migration(migrations.Migration):
    ...
    dependencies = [("input", "0004_non_nullable_fields")]
    ...
    operations = [
        ...
        migrations.RemoveField(model_name="flow", name="alternate"),
        migrations.RemoveField(model_name="load", name="alternate"),
        #
      ...
      set thebuffer_id = (
        ...
        migrations.RemoveField(model_name="operationmaterial", name="thebuffer"),
        migrations.AlterField(
            model_name="operationmaterial",
            name="operation",
            field=models.ForeignKey(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "buffer",
                    models.CharField(
                        db_index=True, verbose_name="buffer", max_length=300
                    ),
                ),
                (
                    "quantity",
                    models.DecimalField(
                        verbose_name="quantity", decimal_places=4, max_digits=15
                    ),
                ),
                ...
                (
                    "onhand",
                    models.DecimalField(
                        verbose_name="onhand", decimal_places=4, max_digits=15
                    ),
                ),
                (
                    "operationplan",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "resource",
                    models.CharField(
                        db_index=True, verbose_name="resource", max_length=300
                    ),
                ),
                (
                    "quantity",
                ...
                (
                    "setup",
                    models.CharField(verbose_name="setup", max_length=300, null=True),
                ),
                (
                    "operationplan",
                    models.ForeignKey(
        ...
        migrations.AlterField(
            ...
            name="location",
            field=models.ForeignKey(
                verbose_name="location", to="input.Location", on_delete=models.CASCADE
            ),
        ),
        ...
        migrations.AddField(
            ...
            field=models.DateTimeField(
                db_index=False, blank=True, null=True, verbose_name="due"
            ),
        ),
        migrations.AddField(
            model_name="operationplan",
            name="delay",
            field=models.DurationField(
                verbose_name="delay", editable=False, blank=True, null=True
            ),
        ),
        migrations.AlterField(
            model_name="operationplan",
     ...
     """,
        ...
        migrations.RemoveField(model_name="item", name="operation"),
    ]
