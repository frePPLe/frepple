...
urlpatterns = patterns('',
    ...
    # Frepple reports
    (r'^buffer/([^/]+)/$', 'freppledb.output.views.view_report', {"report": freppledb.output.views.BufferReport,}),
    (r'^buffer/$', 'freppledb.output.views.view_report', {"report": freppledb.output.views.BufferReport,}),
    (r'^demand/([^/]+)/$', 'freppledb.output.views.view_report', {"report": freppledb.output.views.DemandReport,}),
    (r'^demand/$', 'freppledb.output.views.view_report', {"report": freppledb.output.views.DemandReport,}),
    (r'^resource/([^/]+)/$', 'freppledb.output.views.view_report', {"report": freppledb.output.views.ResourceReport,}),
    (r'^resource/$', 'freppledb.output.views.view_report', {"report": freppledb.output.views.ResourceReport,}),
    (r'^operation/([^/]+)/$', 'freppledb.output.views.view_report', {"report": freppledb.output.views.OperationReport,}),
    (r'^operation/$', 'freppledb.output.views.view_report', {"report": freppledb.output.views.OperationReport,}),
    (r'^forecast/([^/]+)/$', 'freppledb.output.views.view_report', {"report": freppledb.output.views.ForecastReport,}),
    (r'^forecast/$', 'freppledb.output.views.view_report', {"report": freppledb.output.views.ForecastReport,}),
