...
"rtl"===f.direction&&z.attr("dir","rtl");var A="",v="",F,B=!1,D,k=-1,E=b.extend([],f.colModel);D=ea.call(e,h+"_search",g.Find,xa(m,g.findDialogIcon),"right");var I=ea.call(e,h+"_reset",g.Reset,xa(m,g.resetDialogIcon),"left");g.showQuery&&(A=ea.call(e,h+"_query","Query",xa(m,g.queryDialogIcon),"left")+"&#160;");g.searchForAdditionalProperties&&r(f.additionalProperties,function(){var b="string"===typeof this?{name:this}:this;b.label||(b.label=b.name);b.isAddProp=!0;E.push(b)});g.columns.length?(E=g.columns,
...
b.isFunction(v.serializeEditData)?v.serializeEditData:w.serializeEditData,"jqGridAddEditSerializeEditData",y),complete:function(a,e){b("#sData",E).removeClass(V);y[l]=b("#id_g",k).val();if(300<=a.status&&304!==a.status||0===a.status&&4===a.readyState)d[0]=!1,d[1]=t.triggerHandler("jqGridAddEditErrorTextFormat",[a,M]),b.isFunction(v.errorTextFormat)?d[1]=v.errorTextFormat.call(r,a,M):d[1]=e+" Status: '"+a.statusText+"'. Error code: "+a.status;else{d=t.triggerHandler("jqGridAddEditAfterSubmit",[a,y,
...
d[2],p,y):C.addRowData.call(t,d[2],y,v.addedrow),v.closeAfterAdd?(!0!==w.treeGrid&&A.call(t,d[2]),X()):v.clearAfterAdd&&f("_empty",F)):(v.reloadAfterSubmit?(t.trigger("reloadGrid",g),v.closeAfterEdit||setTimeout(function(){A.call(t,y[l])},1E3)):!0===w.treeGrid?C.setTreeRow.call(t,y[l],y):C.setRowData.call(t,y[l],y),v.closeAfterEdit&&X());if(b.isFunction(v.afterComplete)){var n=a;setTimeout(function(){t.triggerHandler("jqGridAddEditAfterComplete",[n,y,b(F),M]);v.afterComplete.call(r,n,y,b(F),M);n=
...
e[1]||"Error deleting the selected row!"):(q.data.oper===h.addoper&&v.closeAfterAdd&&X(),q.data.oper===h.editoper&&v.closeAfterEdit&&X())):"clientArray"===q.url?(v.reloadAfterSubmit=!1,y=q.data,q.complete({status:200,statusText:""},"")):b.ajax(q))}!1===d[0]&&(b("#FormError>td",k).html(d[1]),b("#FormError",k).show())}function m(b,a){var c=!1,d;for(d in b)if(b.hasOwnProperty(d)&&String(b[d])!==String(a[d])){c=!0;break}return c}function l(){var a=!0;b("#FormError",k).hide();v.checkOnUpdate&&(y={},e(),
J=m(y,v._savedData))&&(b(F).data("disabled",!0),b(".confirm",H).show(),a=!1);return a}function n(){var c=u.detectRowEditing.call(r,a);if(null!=c)if("inlineEditing"===c.mode)C.restoreRow.call(t,a);else{var c=c.savedRow,d=r.rows[c.id];C.restoreCell.call(t,c.id,c.ic);b(d.cells[c.ic]).removeClass("edit-cell "+P);b(d).addClass(P).attr({"aria-selected":"true",tabindex:"0"})}}function p(a,c){var d=c[1].length-1;0===a?b("#pData",E).addClass(S):void 0!==c[1][a-1]&&da(b("#"+G(c[1][a-1])),S)?b("#pData",E).addClass(S):
b("#pData",E).removeClass(S);a===d?b("#nData",E).addClass(S):void 0!==c[1][a+1]&&da(b("#"+G(c[1][a+1])),S)?b("#nData",E).addClass(S):b("#nData",E).removeClass(S)}function q(){var a=C.getDataIDs.call(t),c=b("#id_g",k).val();return[b.inArray(c,a),a]}var r=this,t=b(r),w=r.p;if(r.grid&&null!=w&&a){var x=w.id,z=C.getGridRes,A=C.setSelection,v=b.extend(!0,{top:0,left:0,width:300,datawidth:"auto",height:"auto",dataheight:"auto",drag:!0,resize:!0,url:null,mtype:"POST",clearAfterAdd:!0,closeAfterEdit:!1,reloadAfterSubmit:!0,
...
"&#160;")+"</td></tr>");ja[0].rp=0;b(T).append(ja);if(R("beforeInitData",B,M)){n();ra=(ja="rtl"===w.direction?!0:!1)?"nData":"pData";Fa=ja?"pData":"nData";d(a,T,ca);var ra=ea.call(r,ra,"",xa(ba,v.prevIcon),"","left"),Fa=ea.call(r,Fa,"",xa(ba,v.nextIcon),"","right"),Ga=ea.call(r,"sData",v.bSubmit),cb=ea.call(r,"cData",v.bCancel),D="<div class='"+N.call(r,"dialog.footer")+"'><table class='EditTable' id='"+D+"_2'><tbody><tr><td colspan='2'><hr class='"+N.call(r,"dialog.hr")+"' style='margin:1px'/></td></tr><tr id='Act_Buttons'><td class='navButton navButton-"+
w.direction+"'>"+(ja?Fa+ra:ra+Fa)+"</td><td class='EditButton EditButton-"+w.direction+"'>"+Ga+"&#160;"+cb+"</td></tr>",D=D+("<tr style='display:none' class='binfo'><td class='bottominfo' colspan='2'>"+(v.bottominfo||"&#160;")+"</td></tr>"),D=D+"</tbody></table></div>";if(0<O){var $a=[];b.each(b(T)[0].rows,function(b,a){$a[b]=a});$a.sort(function(b,a){return b.rp>a.rp?1:b.rp<a.rp?-1:0});b.each($a,function(a,c){b("tbody",T).append(c)})}v.gbox=L;var ib=!1;!0===v.closeOnEscape&&(v.closeOnEscape=!1,ib=
...
13===v.savekey[1])return b("#sData",E).trigger("click"),!1}if(!0===v.savekey[0]&&a.which===v.savekey[1]&&"TEXTAREA"!==c)return b("#sData",E).trigger("click"),!1;if(27===a.which){if(!l())return!1;ib&&X();return!1}if(!0===v.navkeys[0]){if("_empty"===b("#id_g",k).val())return!0;if(a.which===v.navkeys[1])return b("#pData",E).trigger("click"),!1;if(a.which===v.navkeys[2])return b("#nData",E).trigger("click"),!1}});v.checkOnUpdate&&(b("a.ui-jqdialog-titlebar-close span",H).removeClass("jqmClose"),b("a.ui-jqdialog-titlebar-close",
H).unbind("click").click(function(){if(!l())return!1;X();return!1}));Sa(b("#sData",E),v.saveicon,ba);Sa(b("#cData",E),v.closeicon,ba);if(v.checkOnSubmit||v.checkOnUpdate)Ga=ea.call(r,"sNew",v.bYes),Fa=ea.call(r,"nNew",v.bNo),cb=ea.call(r,"cNew",v.bExit),I=v.zIndex||999,I++,b("<div class='"+v.overlayClass+" jqgrid-overlay confirm' style='z-index:"+I+";display:none;'>&#160;</div><div class='"+N.call(r,"dialog.content","confirm ui-jqconfirm")+"' style='z-index:"+(I+1)+"'>"+v.saveData+"<br/><br/>"+Ga+
Fa+cb+"</div>").insertAfter(F),b("#sNew",H).click(function(){h();b(F).data("disabled",!1);b(".confirm",H).hide();return!1}),b("#nNew",H).click(function(){b(".confirm",H).hide();b(F).data("disabled",!1);setTimeout(function(){b(":input:visible",F)[0].focus()},0);return!1}),b("#cNew",H).click(function(){b(".confirm",H).hide();b(F).data("disabled",!1);X();return!1});R("onInitializeForm",b(F),M);"_empty"!==a&&v.viewPagerButtons?b("#pData,#nData",E).show():b("#pData,#nData",E).hide();R("beforeShowForm",
b(F),M);b(H).data("onClose",v.onClose);u.viewModal.call(r,H,{gbox:L,jqm:v.jqModal,overlay:v.overlay,modal:v.modal,overlayClass:v.overlayClass,toTop:v.toTop,onHide:function(b){b.w.remove();b.o&&b.o.remove()}});qa||b("."+G(v.overlayClass)).click(function(){if(!l())return!1;X();return!1});b(".fm-button",H).hover(function(){b(this).addClass(Y)},function(){b(this).removeClass(Y)});b("#sData",E).click(function(){y={};b("#FormError",k).hide();e();"_empty"===y[x+"_id"]?h():!0===v.checkOnSubmit?(J=m(y,v._savedData))?
(b(F).data("disabled",!0),b(".confirm",H).show()):h():h();return!1});b("#cData",E).click(function(){if(!l())return!1;X();return!1});b("#nData",E).click(function(){if(!l())return!1;b("#FormError",k).hide();var a=q();a[0]=parseInt(a[0],10);if(-1!==a[0]&&a[1][a[0]+1]){if(!R("onclickPgButtons","next",b(F),a[1][a[0]]))return!1;f(a[1][a[0]+1],F);A.call(t,a[1][a[0]+1]);R("afterclickPgButtons","next",b(F),a[1][a[0]+1]);p(a[0]+1,a)}return!1});b("#pData",E).click(function(){if(!l())return!1;b("#FormError",
k).hide();var a=q();if(-1!==a[0]&&a[1][a[0]-1]){if(!R("onclickPgButtons","prev",b(F),a[1][a[0]])||da(b("#"+G(a[1][a[0]-1])),S))return!1;f(a[1][a[0]-1],F);A.call(t,a[1][a[0]-1]);R("afterclickPgButtons","prev",b(F),a[1][a[0]-1]);p(a[0]-1,a)}return!1});R("afterShowForm",b(F),M);qa=q();p(qa[0],qa)}}})},viewGridRow:function(a,c){return this.each(function(){function e(){!0!==q.closeOnEscape&&!0!==q.navkeys[0]||setTimeout(function(){b("#cData").focus()},0)}function d(a,c,d){var e,f,g,h=0,k,p,r=[],t=C.getInd.call(l,
...
(b("td",f).each(function(a){g=B[a];c=g.name;d=g.editrules&&!0===g.editrules.edithidden?!1:!0===g.hidden?!0:!1;"cb"!==c&&"subgrid"!==c&&"rn"!==c&&(c=G("v_"+c),b("#"+c+" span",t).html(u.getDataFieldOfCell.call(m,f,a).html()),d&&b("#"+c,t).parents("tr:first").hide(),e++)}),0<e&&b("#id_g",t).val(a))}function g(a,c){var d=c[1].length-1;0===a?b("#pData",w).addClass(L):void 0!==c[1][a-1]&&da(b("#"+G(c[1][a-1])),L)?b("#pData",w).addClass(L):b("#pData",w).removeClass(L);a===d?b("#nData",w).addClass(L):void 0!==
...
b?b.rowpos||0:0)});K.append(ca);if(E("beforeInitData",K)){d(a,ca,D);var O=(K="rtl"===n.direction?!0:!1)?"pData":"nData",aa=ea.call(m,K?"nData":"pData","",xa(A,q.prevIcon),"","left"),O=ea.call(m,O,"",xa(A,q.nextIcon),"","right"),y=ea.call(m,"cData",q.bClose);if(0<k){var J=[];b.each(b(ca)[0].rows,function(b,a){J[b]=a});J.sort(function(b,a){return b.rp>a.rp?1:b.rp<a.rp?-1:0});b.each(J,function(a,c){b("tbody",ca).append(c)})}q.gbox=F;z=b("<div></div>").append(x).append("<div class='"+N.call(m,"dialog.footer")+
...
B=ea.call(e,"dData",h.bSubmit),k=ea.call(e,"eData",h.bCancel),D=D+("<div class='"+N.call(e,"dialog.footer")+"'><table class='EditTable' id='"+m+"_2'><tbody><tr><td><hr class='"+N.call(e,"dialog.hr")+"' style='margin:1px'/></td></tr><tr><td class='DelButton EditButton EditButton-"+d.direction+"'>"+B+"&#160;"+k+"</td></tr></tbody></table></div>");h.gbox=x;u.createModal.call(e,t,D,h,d.gView,b(d.gView)[0]);b("#DelData>td",l).data("rowids",a);if(!A("beforeInitData",b(D)))return;b(".fm-button",l+"_2").hover(function(){b(this).addClass(v)},
...
!1}},B=U.call(m,"hover"),D=U.call(m,"disabled"),k=N.call(m,"navButton","ui-pg-button");if(m.grid){m.modalAlert=A;void 0===a&&(l.pager?(a=l.pager,l.toppager&&(q.cloneToTop=!0)):l.toppager&&(a=l.toppager));var E=1,I,H,L,K,aa,J,O=["left","center","right"],y="<div class='"+N.call(m,"navButton","ui-pg-button "+U.call(m,"disabled"))+"'><span class='ui-separator'></span></div>",P=function(){da(this,D)||b(this).addClass(B)},M=function(){b(this).removeClass(B)},ba=function(){da(this,D)||(b.isFunction(q.addfunc)?
q.addfunc.call(m):C.editGridRow.call(n,"new",d));return!1},X=function(a,c,d){if(!da(this,D)){var e=l.selrow;e?b.isFunction(a)?a.call(m,e):C[c].call(n,e,d):A()}return!1},T=function(){return X.call(this,q.editfunc,"editGridRow",e)},R=function(){return X.call(this,q.viewfunc,"viewGridRow",h)},Y=function(){var a;da(this,D)||(l.multiselect?(a=l.selarrrow,0===a.length&&(a=null)):a=l.selrow,a?b.isFunction(q.delfunc)?q.delfunc.call(m,a):C.delGridRow.call(n,a,f):A());return!1},S=function(){da(this,D)||(b.isFunction(q.searchfunc)?
q.searchfunc.call(m,g):C.searchGrid.call(n,g));return!1},Z=function(){if(!da(this,D)){b.isFunction(q.beforeRefresh)&&q.beforeRefresh.call(m);l.search=!1;l.resetsearch=!0;try{if("currentfilter"!==q.refreshstate){l.postData.filters="";try{b("#fbox_"+t).jqFilter("resetFilter")}catch(a){}b.isFunction(m.clearToolbar)&&m.clearToolbar(!1)}}catch(a){}switch(q.refreshstate){case "firstpage":n.trigger("reloadGrid",[b.extend({},q.reloadGridOptions||{},{page:1})]);break;case "current":case "currentfilter":n.trigger("reloadGrid",
[b.extend({},q.reloadGridOptions||{},{current:!0})])}b.isFunction(q.afterRefresh)&&q.afterRefresh.call(m)}return!1},V=function(a,c,d){var e=b("<div class='"+k+"' tabindex='0' role='button'></div>"),f=q[a+"icon"],g=b.trim(q[a+"text"]);e.append("<div class='ui-pg-div'><span class='"+(q.iconsOverText?xa("ui-pg-button-icon-over-text",x,f):xa(x,f))+"'></span>"+(g?"<span class='ui-pg-button-text"+(q.iconsOverText?" ui-pg-button-icon-over-text":"")+"'>"+g+"</span>":"")+"</div>");b(v).append(e);e.attr({title:q[a+
"title"]||"",id:c||a+"_"+L}).click(d).hover(P,M);return e};q.cloneToTop&&l.toppager&&(E=2);for(I=0;I<E;I++){v=b("<div class='ui-pg-table navtable' role='toolbar' style='float:"+("rtl"===l.direction?"right":"left")+";table-layout:auto;'></div>");0===I?(H=a,L=p,H===l.toppager&&(L+="_top",E=1)):(H=l.toppager,L=p+"_top");q.add&&V("add",d.id,ba);q.edit&&V("edit",e.id,T);q.view&&V("view",h.id,R);q.del&&V("del",f.id,Y);(q.add||q.edit||q.del||q.view)&&b(v).append(y);q.search&&(r=V("search",g.id,S),g.showOnLoad&&
!0===g.showOnLoad&&b(r,v).click());q.refresh&&V("refresh","",Z);r=b(".ui-jqgrid>.ui-jqgrid-view").css("font-size")||"11px";b("body").append("<div id='testpg2' class='"+N.call(m,"gBox","ui-jqgrid")+"' style='font-size:"+r+";visibility:hidden;' ></div>");r=b(v).clone().appendTo("#testpg2").width();b("#testpg2").remove();b(H+"_"+q.position,H).append(v);if(q.hideEmptyPagerParts)for(K=0;K<O.length;K++)O[K]!==q.position&&(J=b(H+"_"+O[K],H),0===J.length||0===J[0].childNodes.length?J.hide():1===J[0].childNodes.length&&
...
[],d=[],N=Array(I),O=Array(x),y,P,M,T,X,U,R,Y,S,Z,V;n=function(c,d,e){c=new oa(m.trimByCollect,m.caseSensitive,d,c);b.isFunction(e)&&(c.compareVectorsEx=e);c.createDataIndex(a);return c};var da=function(a,c,d,f,g){var k,h;switch(a){case 1:k=C[f].totalText||"{0} {1} {2}";h="y"+g+"t"+f;break;case 2:k=m.totalText||"{0}";h="t";break;default:k=1<I?c.label||"{0}":V.getItem(g)[f],h="y"+g}a=b.extend({},c,{name:h+(1<I?"a"+d:""),label:b.isFunction(k)?k.call(e,2===a?{aggregate:c,iAggregate:d,pivotOptions:m}:
{yIndex:V.getItem(g),aggregate:c,iAggregate:d,yLevel:f,pivotOptions:m}):u.template.apply(e,2===a?[k,c.aggregator,c.member,d]:[k,c.aggregator,c.member,V.getItem(g)[f],f])});delete a.member;delete a.aggregator;return a};z=function(b,a,c){var d,e;for(d=0;d<I;d++)e=B[d],void 0===e.template&&void 0===e.formatter&&m.defaultFormatting&&(e.template="count"===e.aggregator?"integer":"number"),J.push(da(b,e,d,a,c))};y=function(a,c,d){var f,g,k,h;for(f=H-1;f>=c;f--)if(K[f]){for(g=0;g<=f;g++)S=G[g].groupHeaders,
S[S.length-1].numberOfColumns+=I;r=C[f];k=r.totalHeader;h=r.headerOnTop;for(g=f+1;g<=H-1;g++)G[g].groupHeaders.push({titleText:h&&g===f+1||!h&&g===H-1?b.isFunction(k)?k.call(e,d,f):u.template.call(e,k||"",d[f],f):"",startColumnName:"y"+(a-1)+"t"+f+(1===I?"":"a0"),numberOfColumns:I})}};var ea=function(a){a=new na("count"===B[a].aggregator?"sum":B[a].aggregator,e,c);a.groupInfo={iRows:[],rows:[],ys:[],iYs:[]};return a},ga=function(){var a,b;for(a=H-1;0<=a;a--)if(K[a])for(null==O[a]&&(O[a]=Array(I)),
b=0;b<I;b++)O[a][b]=ea(b)},ha=function(a,b,c,d){var e,f=V.getIndexOfDifferences(b,c),g,k;if(null!==c)for(f=Math.max(f,0),e=H-1;e>=f;e--)g="y"+a+"t"+e+(1<I?"a"+d:""),K[e]&&void 0===R[g]&&(k=O[e][d],k.getResult(R,g),R.pivotInfos[g]={colType:1,iA:d,a:B[d],level:e,iRows:k.groupInfo.iRows,rows:k.groupInfo.rows,ys:k.groupInfo.ys,iYs:k.groupInfo.iYs},b!==c&&(O[e][d]=ea(d)))},ia=function(c,d,e,f,g,k,h){var l;if(c!==d)for(d=H-1;0<=d;d--)K[d]&&(l=O[d][f],l.calc(g[e.member],e.member,g,k,a),l=l.groupInfo,0>b.inArray(h,
l.iYs)&&(l.iYs.push(h),l.ys.push(c)),0>b.inArray(k,l.iRows)&&(l.iRows.push(k),l.rows.push(g)))};if(0===E||0===I)throw"xDimension or aggregates options are not set!";Z=n(v,m.skipSortByX,m.compareVectorsByX);V=n(C,m.skipSortByY,m.compareVectorsByY);c.xIndex=Z;c.yIndex=V;for(n=0;n<E;n++)p=v[n],t={name:"x"+n,label:null!=p.label?b.isFunction(p.label)?p.label.call(e,p,n,m):p.label:p.dataName,frozen:m.frozenStaticCols},n<E-1&&(g.groupField.push(t.name),g.groupSummary.push(m.groupSummary),g.groupSummaryPos.push(m.groupSummaryPos)),
t=b.extend(t,p),delete t.dataName,delete t.footerText,J.push(t);2>E&&(h.grouping=!1);h.sortname=J[E-1].name;g.hideFirstGroupCol=!0;for(n=0;n<x;n++)r=C[n],K.push(r.totals||r.rowTotals||r.totalText||r.totalHeader?!0:!1);Y=V.getItem(0);z(0,x-1,0);g=V.getIndexLength();for(t=1;t<g;t++){M=V.getItem(t);n=V.getIndexOfDifferences(M,Y);for(p=H-1;p>=n;p--)K[p]&&z(1,p,t-1);Y=M;z(0,x-1,t)}for(n=H-1;0<=n;n--)K[n]&&z(1,n,g-1);q&&z(2);Y=V.getItem(0);for(p=0;p<H;p++)G.push({useColSpanStyle:m.useColSpanStyle,groupHeaders:[{titleText:Y[p],
startColumnName:1===I?"y0":"y0a0",numberOfColumns:I}]});for(t=1;t<g;t++){M=V.getItem(t);n=V.getIndexOfDifferences(M,Y);y(t,n,Y);for(p=H-1;p>=n;p--)G[p].groupHeaders.push({titleText:M[p],startColumnName:"y"+t+(1===I?"":"a0"),numberOfColumns:I});for(p=0;p<n;p++)S=G[p].groupHeaders,S[S.length-1].numberOfColumns+=I;Y=M}y(g,0,Y);if(q)for(n=0;n<H;n++)G[n].groupHeaders.push({titleText:n<H-1?"":m.totalHeader||"",startColumnName:"t"+(1===I?"":"a0"),numberOfColumns:I});y=Z.getIndexLength();for(x=0;x<y;x++){p=
Z.getItem(x);z={iX:x,x:p};R={pivotInfos:z};for(n=0;n<E;n++)R["x"+n]=p[n];P=Z.getIndexesOfSourceData(x);if(q)for(p=0;p<I;p++)N[p]=ea(p);Y=null;ga();for(t=0;t<g;t++){M=V.getItem(t);T=V.getIndexesOfSourceData(t);for(p=0;p<I;p++){null!==Y&&ha(t-1,M,Y,p);X=[];for(n=0;n<T.length;n++)w=T[n],0<=b.inArray(w,P)&&X.push(w);if(0<X.length){A=Array(X.length);U=B[p];D=new na(U.aggregator,e,c);for(w=0;w<X.length;w++)n=X[w],l=a[n],A[w]=l,D.calc(l[U.member],U.member,l,n,a),q&&(k=N[p],k.calc(l[U.member],U.member,l,
...
E;n++)f["x"+n]=v[n].footerText||"";for(n=E;n<J.length;n++){l=J[n].name;D=new na(m.footerAggregator||"sum",e,c);for(w=0;w<q;w++)R=d[w],D.calc(R[l],l,R,w,d);D.getResult(f,l)}}c.colHeaders=G;return{colModel:J,options:c,rows:d,groupOptions:h,groupHeaders:G,summary:f}},jqPivot:function(a,c,e,d){return this.each(function(){function f(){var d=m.pivotSetup.call(h,a,c),f=d.groupHeaders,p=d.summary,q=0,r;for(r in p)p.hasOwnProperty(r)&&q++;p=0<q?!0:!1;q=d.groupOptions.groupingView;r=u.from.call(g,d.rows);var t;
