...
urlpatterns = patterns(
  ...
  url(r'^data/input/operationresource/$', freppledb.input.views.OperationResourceList.as_view(), name="admin:input_operationresource_changelist"),
  url(r'^data/input/operationmaterial/$', freppledb.input.views.OperationMaterialList.as_view(), name="admin:input_operationmaterial_changelist"),
  ...
  url(r'^data/input/manufacturingorder/$', freppledb.input.views.ManufacturingOrderList.as_view(), name="admin:input_manufacturingorder_changelist"),
  ...
  (r'^api/input/operationresource/$', freppledb.input.serializers.OperationResourceAPI.as_view()),
  (r'^api/input/operationmaterial/$', freppledb.input.serializers.OperationMaterialAPI.as_view()),
  ...
  (r'^api/input/manufacturingorder/$', freppledb.input.serializers.ManufacturingOrderAPI.as_view()),
  ...
  (r'^api/input/deliveryorder/$', freppledb.input.serializers.DeliveryOrderAPI.as_view()),
  ...
  (r'^api/input/operationresource/(?P<pk>(.+))/$', freppledb.input.serializers.OperationResourcedetailAPI.as_view()),
  (r'^api/input/operationmaterial/(?P<pk>(.+))/$', freppledb.input.serializers.OperationMaterialdetailAPI.as_view()),
  ...
  (r'^api/input/manufacturingorder/(?P<pk>(.+))/$', freppledb.input.serializers.ManufacturingOrderdetailAPI.as_view()),
  ...
  (r'^api/input/deliveryorder/(?P<pk>(.+))/$', freppledb.input.serializers.DeliveryOrderdetailAPI.as_view()),
