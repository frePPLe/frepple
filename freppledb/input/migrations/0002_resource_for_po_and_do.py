...
class Migration(migrations.Migration):
  ...
  operations = [
    migrations.AddField(
      ...
      name='resource',
      field=models.ForeignKey(verbose_name='resource', help_text='Resource to model the distribution capacity', null=True, related_name='itemdistributions', to='input.Resource', blank=True, on_delete = None),
    ),
    migrations.AddField(
      model_name='itemdistribution',
      name='resource_qty',
    ...
    migrations.AddField(
      ...
      name='resource',
      field=models.ForeignKey(verbose_name='resource', help_text='Resource to model the supplier capacity', null=True, related_name='itemsuppliers', to='input.Resource', blank=True, on_delete = None),
    ),
    migrations.AddField(
      model_name='itemsupplier',
      name='resource_qty',
